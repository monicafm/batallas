...
abstract class Participante {
    ...
    public boolean aciertaEnCoordenadaContraria(Coordenada coorde,List<Coordenada> flota) {
    ...
    public boolean comprobarConjuntoDisparos(Coordenada c,List<Coordenada> arrayCoorde){
    ...
    public List<Coordenada> añadirDisparo(Coordenada co, List<Coordenada> conjuntoDisparo){
